...
@push('scripts')
    <script>
                            ...
                            if (row.status_cucian === 'Orderan Masuk') {
                                return `<div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                ...
                                                <li><a class="dropdown-item" href="/orderLangsung/setLocation/${row.id}">Set Location</a></li>
                                            </ul>
                                        </div>`;
                            }
                ...
                success: function(response) {
                    ...
                    snap.pay(response.snap_token, {
                        ...
                        onSuccess: function(result) {
                            ...
                            window.location.href = 'orderLangsung/bayar/success/' + response
                                .snap_token;
                        },
                        // Optional
        ...
        $('#addModalOrderLangsung').on('show.bs.modal', function(event) {
            ...
            if (id) {
                form.attr('action', '/orderLangsung/edit/' + id);
            } else {
